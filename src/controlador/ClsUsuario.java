...
public class ClsUsuario {
    ...
    public boolean validaUsuario(IdUsuario idus){
        ...
        sql = "SELECT login, pww FROM usuario ";        
        ...
        try {
            ...
            if(rs!=null)
            {
                while(rs.next()){
                    ...
                    if(rs.getString("login").equals(idus.getLogin()) && rs.getString("pww").equals(idus.getPw())){
                        result=true;
                    }
                }
            }
    ...
    public String createUsuario(IdUsuario idus) 
    {
       ...
       if(idus.getPw().equals(idus.getConfirmPw())){
        ...
        try {
            ...
            sql="INSERT INTO usuario (id_usuario, login, pww) "
    ...
    public ArrayList SeleccionarUsuario(IdUsuario idus)
    {
        ArrayList ls = new ArrayList<String>();
            sql = "SELECT id_usuario , login, pww FROM usuario "+idus.getCondicion();
        try {
